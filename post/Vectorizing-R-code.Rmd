...
<br>
In everyday life, we continuously use numbers and perform predefined operations, such as addition $+$, subtraction $-$, and multiplication $\times$ that all take two and return one number. 
<br>
